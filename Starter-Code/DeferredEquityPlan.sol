...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        // require(unlock_time <= now, "Shares are not yet vested, try again later.");
        require(unlock_time <= fakenow, "Shares are not yet vested, try again later.");
        // 2: `distributed_shares` is less than the `total_shares`
        require(distributed_shares < total_shares, "All eligible shares have been vested");
